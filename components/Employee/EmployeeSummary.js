...
function EmployeeSummary({ employee }) {
  ...
  const isArchived = employee.archived === "Yes";
      ...
      <Item>
        ...
        <Item.Content>
          ...
          <Item.Description>
            ...
            <h3>
              <strong> {employee.employment} </strong>
            </h3>
            {isMOD && (
              <Label circular color="black">
                MOD
            ...
            <br />
            <p>
              <strong>D.O.B:</strong> {formatDate(employee.dob)}{" "}
            </p>
            <p>
              <strong>Start Date:</strong> {formatDate(employee.startDate)}{" "}
            </p>
            <p>
            ...
            <p>
              <strong>Emergency Phone:</strong> {employee.emergencyPhone}{" "}
            </p>
            <p>
              <strong>Address:</strong> {employee.address}, {employee.suburb},{" "}
              {employee.state}, {employee.postcode}{" "}
            </p>
          </Item.Description>
        </Item.Content>
      </Item>
