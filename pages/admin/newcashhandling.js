...
function NewCashhandling() {
    ...
    const createCashhandling = async () => {
        try {
            const res = await fetch(`${baseUrl}/api/cashhandling`, {
                method: 'POST',
                headers: {
    ...
    return (
        <>
            <Header as="h2" block>
                ...
                Add New Cash Handling Incident
            </Header>
            {
                isSubmitting
                    ...
                    : <Form onSubmit={handleSubmit}>
                        <Form.Field
                            ...
                            placeholder= "Cash Handling Incident Type"
...
export default NewCashhandling