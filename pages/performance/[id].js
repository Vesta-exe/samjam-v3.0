...
function PerformanceNote({ performanceData }) {
  ...
  const isMeeting = performance.type === "Meeting";
  ...
  const deletePerformance = async () => {
    ...
    try {
      const deleted = await fetch(
        `${baseUrl}/api/performance/${performanceId}`,
        {
          method: "DELETE",
        }
      );
          ...
          <Item.Group>
            <Item>
              <Item.Content>
                ...
                <p>
                  <strong>Followup Manager: </strong>
                  {performance.followupManager}
                </p>
                <p>
                  <strong>Followup Description: </strong>
                  {performance.followupDescription}
                </p>
                <p>
